...
class TransferDataset(Dataset):
    def __init__(self, args, generate_heatemap_cfgs) -> None:
        ...
        assert self.dataset_name.lower() in ["barbiegait", "sustech1k", "grew", "ccpg", "oumvlp", "ou-mvlp", "gait3d", "casiab", "casiae"], f"Invalid dataset name: {self.dataset_name}"
...
def get_args():
    ...
    parser.add_argument('--ext_name', type=str, default='', help="Reserved for compatibility with the original script.")
    parser.add_argument('--dataset_name', type=str, default='BarbieGait', help="Name of the dataset being preprocessed.")
    parser.add_argument('--heatemap_cfg_path', type=str, default=str(SCRIPT_DIR / 'BarbieGait' / 'pretreatment_heatmap.yaml'), help="Path to the heatmap generator configuration file.")
